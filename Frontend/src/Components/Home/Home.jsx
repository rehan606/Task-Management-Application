...
const Home = () => {
    ...
    const handleSubmit = (e) => {
        ...
        const taskData = { title, description, date, category }
        console.log(taskData);
        


        // fetch data in client side with server URL
            ...
            {isModalOpen && (
                ...
                <div className="bg-white p-6 rounded-lg shadow-lg w-96">
                    ...
                    <div className="mb-4">
                        ...
                        <input type="text" name="title" className="input border-primary bg-white text-primary input-bordered w-full" />
                    </div>
                    <div className="mb-4">
                        <label className="block text-sm font-medium text-primary">Description</label>
                        <textarea name="description" className="textarea border-primary bg-white text-primary textarea-bordered w-full"></textarea>
                    </div>
                    <div className="mb-4">
                        <label className="block text-sm font-medium text-primary">Date</label>
                        <input name="date" type="date" className="input border-primary bg-white text-primary input-bordered w-full" />
                    </div>
                    <div className="mb-4">
                        <label className="block text-sm font-medium text-primary">Category</label>
                        <select name="select" className="select select-bordered w-full border-primary bg-white text-primary">
